...
### Folders-by-Feature Structure
  ...
  │   │   │   └── list.module.spec.js
  │   │   ├── contacts.module.js
  │   │   ├── contacts.module.spec.js
  │   │   ├── contacts.module.less
  │   │   └── contacts.module.html
  │   └── about
  │       ├── about.module.js
  │       ├── about.module.spec.js
  │       ├── about.module.html
  │       ├── about.module.less
  │       └── about.controller.js
  └── components
  ...
  * When creating directives it may be useful to put all the files associated with the given directive files (i.e. templates, CSS/LESS files, JavaScript) in a single folder.
  ...
  * The `app.js` file contains configuration and/or manual bootstrap (if required).
  * The main js file in a module contains its route/state definition.
...
* For content that is initialized only once and then never changed, use single-time watchers (one-way data binding).
